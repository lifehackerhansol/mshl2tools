rm -f mshl2tools.7z
7z a -r0 -mx=9 -xr0!*/.svn/* -xr0!*/.svn mshl2tools.7z *.sh arm7 bootlib libfat libelm libprism readme.txt license.txt \
...
ysall vhbootlib savbackup m3region xenofile nds_backup_tool_memory yswood woodload fwrecovery unbrickgwinstaller nesdswrap \
memdump stripmbr ttloader r4dump reset_mse_arco argvview argvloader reset_ievo \
wdayloader gbadump google2fa frontend2assoc
...
cp -f unbrickgwinstaller/unbrickgwinstaller.nds internal/tool/
