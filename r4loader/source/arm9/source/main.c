...
void SoftReset(void)
{
	...
	//magic
	*(vu32*)0x023fd900=0x1e|(14<<8);
	strcpy(0x023fda00,"fat1:");
	_FAT_directory_ucs2tombs(0x023fda05,extlink.DataFullPathFilenameUnicode,762);
	strcpy(0x023fdd00,"fat1:");
	char utf8[768];
	_FAT_directory_ucs2tombs(utf8,extlink.DataFullPathFilenameUnicode,768);
	strcpy(utf8+strlen(utf8)-3,"sav");
	if(!stat(utf8,NULL))strcpy(0x023fdd05,utf8);
